<main class="container mx-auto px-6 lg:px-14 py-4">
	...
	>
		<p>
			This project is <span><a class="text-blue-500" href="https://boadzie1.netlify.app">my</a></span> way of show casing my web developement skills using the awesome
			SvelteKit framework and it's companion framework, Tailwindcss. These two together makes building
			web applications fast and easy. <span
				...
				That is why this application showcases the use of <a
					class="text-blue-500"
